...
namespace Coordinator.Migrations
{
    ...
    [Migration("20250511073533_createdb")]
            ...
            modelBuilder.Entity("Coordinator.Models.Node", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("966c1571-2f27-45e8-bcb5-98a11c69053b"),
                            name = "OrderAPI"
                        },
                        new
                        {
                            Id = new Guid("63c4d47a-75cd-4688-932f-f168f8c0e319"),
                            name = "StockAPI"
                        },
                        new
                        {
                            Id = new Guid("35105515-6955-4fa5-8c73-a47d8e4f5d31"),
                            name = "PaymentAPI"
                        });
                });
